  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="mb-4 flex w-8/12">
        ...
        <div className="w-1/2 mx-4">
            <button type="submit" className="w-7/12 text-center text-lg py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-bold text-white bg-[#F8A51B] hover:bg-bg-[#F8A51B] focus:outline-none">
                Add
            </button>
        </div>
